...
volume = float(input("Enter the volume in litre: "))
temperature = float(input("Enter the temperature in Kelvin: "))
total_amount_of_gas_in_moles = computeGasInMoles(pressure, volume, temperature)
print(f"Total amount of gas in Moles: {total_amount_of_gas_in_moles}")
